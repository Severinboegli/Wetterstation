...
IPAddress ip(192, 168, 138, 2);       // IP-Adresse des Arduino
IPAddress serverIP(192, 168, 138, 1); // IP-Adresse des Servers, an den du Daten senden möchtest
...
void loop()
{
  ...
  if (client.connect(serverIP, serverPort))
  {
    ...
    client.println("POST /wetterstation/Website/PHP/upload_data_altnau.php HTTP/1.1");
    client.print("Host: ");
    client.println(serverIP);
